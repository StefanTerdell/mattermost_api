...
impl Mattermost {
    ...
    fn endpoint_url(&self, endpoint: impl AsRef<str>) -> Result<Url, ApiError> {
        Ok(self
            .instance_url
            .join(endpoint.as_ref().trim_start_matches('/'))?)
    }
    ...
    where
        T: DeserializeOwned,
        Method: TryFrom<M, Error = http::method::InvalidMethod>,
    {
    ...
    pub async fn get_team(&self, id: impl AsRef<str>) -> Result<models::TeamInformation, ApiError> {
        self.query("GET", &format!("teams/{}", id.as_ref()), None, None)
            .await
    }
    ...
    pub async fn get_team_by_name(
        &self,
        name: impl AsRef<str>,
    ) -> Result<models::TeamInformation, ApiError> {
        self.query("GET", &format!("teams/name/{}", name.as_ref()), None, None)
            .await
    }
    ...
    pub async fn get_team_unreads_for(
        ...
        self.query(
            "GET",
            &format!("users/{}/teams/unread", user_id.as_ref()),
            None,
            None,
        )
        .await
    ...
    pub async fn get_channel(
        ...
        self.query(
            "GET",
            &format!("channels/{}", channel_id.as_ref()),
            None,
            None,
        )
        .await
    ...
    pub async fn get_public_channels(
        ...
        self.query(
            "GET",
            &format!("teams/{}/channels", team_id.as_ref()),
            None,
            None,
        )
        .await
